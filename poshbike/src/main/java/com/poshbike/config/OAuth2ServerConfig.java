...
import com.poshbike.oauth.SparklerUserApprovalHandler;
...
public class OAuth2ServerConfig {
	...
	protected static class Stuff {
		...
		public SparklerUserApprovalHandler userApprovalHandler() throws Exception {
			SparklerUserApprovalHandler handler = new SparklerUserApprovalHandler();
